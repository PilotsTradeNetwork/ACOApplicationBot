...
from ptn.aco.constants import bot_guild_id, TOKEN, get_bot_control_channel, get_member_role_id
...
class DiscordBotCommands(commands.Cog):
    ...
    async def exit(self, ctx):
        ...
        await bot.tree.clear_commands(self.bot.user.id, TOKEN, [bot_guild_id()])
